...
const Sidebar = () => {
  return (
    <aside className="w-16 bg-gray-900 h-full overflow-y-auto flex flex-col items-center py-4">
      {sidebarItems.map((item, index) => (
        <Link href={item.href} key={index} className="w-12 h-12 flex items-center justify-center text-gray-300 hover:bg-gray-800 rounded-lg mb-4">
          {item.icon}
        </Link>
      ))}
      <div className="mt-auto">
        <Link href="/profile" className="w-12 h-12 flex items-center justify-center text-gray-300 hover:bg-gray-800 rounded-lg">
